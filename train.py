...
parser.add_argument('--data_path', default='/share/share/aixi/', type=str, help='data path')
...
parser.add_argument('--num_frame', default=1, type=int, help='number of frames for each clip')
